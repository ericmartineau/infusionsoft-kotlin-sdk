...
class MerchantApi(bearerToken:String, basePath: String, gson: Gson) : ApiClient(basePath, bearerToken, gson) {
  ...
  fun getMerchantAccounts() : RestMerchantAccountResponse {
    ...
    val response = request<RestMerchantAccountResponse>(localVariableConfig, requestBody)

    return when (response) {
      is Success<*> -> response.data as RestMerchantAccountResponse
