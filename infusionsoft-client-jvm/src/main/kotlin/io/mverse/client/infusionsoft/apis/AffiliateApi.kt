...
class AffiliateApiImpl(bearerToken:String, basePath: String, gson: Gson) : AffiliateApi, ApiClient(basePath, bearerToken, gson) {
  ...
  override fun retrieveAffiliateModel() : ObjectModel {
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun searchCommissions(since: String?, until: String?, limit: Int?, offset: Int?, affiliateId: Long?) : AffiliateCommissionList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
