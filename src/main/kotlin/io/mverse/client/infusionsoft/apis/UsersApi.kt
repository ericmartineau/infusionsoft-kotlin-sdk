...
if (includeInactive != null) localVariableQuery["include_inactive"] to listOf("$includeInactive")
if (includePartners != null) localVariableQuery["include_partners"] to listOf("$includePartners")
