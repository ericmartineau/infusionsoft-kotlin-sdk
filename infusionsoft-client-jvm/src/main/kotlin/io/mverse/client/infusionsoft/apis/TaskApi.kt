...
class TaskApiImpl(bearerToken:String, basePath: String, gson: Gson) : TaskApi, ApiClient(basePath, bearerToken, gson) {
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listTasks(contactId: Long?, hasDueDate: Boolean?, userId: Long?, since: String?, until: String?, completed: Boolean?, limit: Int?, offset: Int?, order: String?) : TaskList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listTasksForCurrentUser(contactId: Long?, hasDueDate: Boolean?, userId: Long?, since: String?, until: String?, completed: Boolean?, limit: Int?, offset: Int?, order: String?) : TaskList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    if (contactId != null) localVariableQuery["contact_id"] = listOf("$contactId")
    if (hasDueDate != null) localVariableQuery["has_due_date"] = listOf("$hasDueDate")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun retrieveTaskModel() : ObjectModel {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun updatePropertiesOnTask(taskId: String, task: Task) : Task {
    val requestBody = task
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun updateTask(taskId: String, task: Task) : Task {
    val requestBody = task
    val localVariableQuery: MultiValueMap = mutableMapOf()
