...
class CompanyApiImpl(bearerToken:String, basePath: String, gson: Gson) : CompanyApi, ApiClient(basePath, bearerToken, gson) {
  ...
  override fun createCompany(company: CreateOrPatchCompany?) : Company {
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listCompanies(limit: Int?, offset: Int?, companyName: String?, order: String?, orderDirection: String?, optionalProperties: List<String>?) : CompanyList {
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun retrieveCompanyModel() : ObjectModel {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun updatePropertiesOnContact(companyId: Long, company: CreateOrPatchCompany?) : Company {
    val requestBody = company
    val localVariableQuery: MultiValueMap = mutableMapOf()
