...
import io.mverse.client.infusionsoft.models.CreateContactOrigin
...
import io.mverse.client.infusionsoft.models.RequestCompanyReference
...
data class UpsertContact (
    ...
    @SerialName("duplicate_option") @Optional val duplicateOption: UpsertContact.DuplicateOption? = null,
    ...
    @SerialName("source_type") @Optional val sourceType: UpsertContact.SourceType? = null,
    ...
    /**
    * 
    * Values: EMAIL,EMAILANDNAME
    */
    @Serializable(with = DuplicateOption.Serializer::class)
    enum class DuplicateOption(val value: String){
      ...
      class Serializer: EnumStringSerializer<DuplicateOption>(DuplicateOption::class)
