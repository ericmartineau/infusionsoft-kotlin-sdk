...
class ContactApiImpl(bearerToken:String, basePath: String, gson: Gson) : ContactApi, ApiClient(basePath, bearerToken, gson) {
  ...
  override fun applyTagsToContactId(contactId: Long, tagIds: TagId) : List<EntryLongCommastring_> {
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun createContact(contact: CreateOrPatchContact?) : FullContact {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<FullContact>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun createCreditCard(contactId: Long, creditCard: CreditCard?) : CreditCardAdded {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<CreditCardAdded>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun createCustomField(customField: CreateRestCustomField) : CustomFieldMetaData {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<CustomFieldMetaData>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun createEmailForContact(contactId: Long, emailWithContent: EmailSentCreate?) : EmailSentCreate {
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun createOrUpdateContact(contact: UpsertContact?) : FullContact {
    val requestBody = contact
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   *  * @return void
   */ 
  override fun deleteContact(contactId: Long) : Unit {
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun getContact(id: Long, optionalProperties: List<String>?) : FullContact {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listAppliedTags(contactId: Long, limit: Int?, offset: Int?) : ContactTagList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<ContactTagList>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listContacts(limit: Int?, offset: Int?, email: String?, givenName: String?, familyName: String?, order: String?, orderDirection: String?, since: String?, until: String?) : ContactList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    if (limit != null) localVariableQuery["limit"] = listOf("$limit")
    if (offset != null) localVariableQuery["offset"] = listOf("$offset")
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<ContactList>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listCreditCards(contactId: Long) : List<ContactCreditCard> {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<List<ContactCreditCard>>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listEmailsForContact(contactId: Long, limit: Int?, offset: Int?, email: String?) : EmailSentQueryResultList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    if (limit != null) localVariableQuery["limit"] = listOf("$limit")
    if (offset != null) localVariableQuery["offset"] = listOf("$offset")
   ...
   *  * @return void
   */ 
  override fun removeTagsFromContact(contactId: Long, ids: String) : Unit {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   *  * @return void
   */ 
  override fun removeTagsFromContact1(contactId: Long, tagId: Long) : Unit {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun retrieveContactModel() : ObjectModel {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun updatePropertiesOnContact1(contactId: Long, contact: CreateOrPatchContact?, updateMask: List<String>?) : FullContact {
    val requestBody = contact
    val localVariableQuery: MultiValueMap = mutableMapOf()
