...
class ECommerceApiImpl(bearerToken:String, basePath: String, gson: Gson) : ECommerceApi, ApiClient(basePath, bearerToken, gson) {
  ...
  override fun createOrder(createOrder: CreateOrder) : Order {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<Order>() {}.type)
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun createOrderItemsOnOrder(createOrderItem: CreateOrderItem, orderId: Long) : OrderItem {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<OrderItem>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun createPaymentOnOrder(orderId: Long, createPayment: CreatePayment?) : PaymentResult {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<PaymentResult>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   *  * @return void
   */ 
  override fun deleteOrder(orderId: Long) : Unit {
   ...
   *  * @return void
   */ 
  override fun deleteOrderOrderItem(orderId: Long, orderItemId: Long) : Unit {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
  ...
  override fun getTransaction(transactionId: Long) : Transaction {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<Transaction>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listOrders(since: String?, until: String?, limit: Int?, offset: Int?, paid: Boolean?, order: String?, contactId: Long?, productId: Long?) : OrderList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<OrderList>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listSubscriptions(limit: Int?, offset: Int?, contactId: Long?) : SubscriptionList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    if (limit != null) localVariableQuery["limit"] = listOf("$limit")
    if (offset != null) localVariableQuery["offset"] = listOf("$offset")
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<SubscriptionList>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listTransactions(since: String?, until: String?, limit: Int?, offset: Int?, contactId: Long?) : TransactionList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    if (since != null) localVariableQuery["since"] = listOf("$since")
    if (until != null) localVariableQuery["until"] = listOf("$until")
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<TransactionList>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listTransactionsForOrder(orderId: Long, since: String?, until: String?, limit: Int?, offset: Int?, contactId: Long?) : TransactionList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    if (since != null) localVariableQuery["since"] = listOf("$since")
    if (until != null) localVariableQuery["until"] = listOf("$until")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun replacePaymentPlan(orderId: Long, paymentPlan: PaymentPlan) : PaymentPlan {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<PaymentPlan>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun retrieveOrderModel() : ObjectModel {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun retrieveSubscriptionModel() : ObjectModel {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
