...
class OpportunityApiImpl(bearerToken:String, basePath: String, gson: Gson) : OpportunityApi, ApiClient(basePath, bearerToken, gson) {
  ...
  override fun createOpportunity(opportunity: Opportunity?) : Opportunity {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<Opportunity>() {}.type)
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun getOpportunity(opportunityId: Long, optionalProperties: List<String>?) : Opportunity {
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listOpportunities(limit: Int?, offset: Int?, userId: Long?, stageId: Long?, searchTerm: String?, order: String?) : OpportunityList {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<OpportunityList>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun listOpportunityStagePipelines() : List<SalesPipeline> {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<List<SalesPipeline>>() {}.type)
      is Informational -> TODO()
      is Redirection -> TODO()
      is ClientError -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError -> throw ServerException(response.message ?: "Server error")
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun retrieveOpportunityModel() : ObjectModel {
    val requestBody = null
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun updateOpportunity(opportunity: Opportunity?) : Opportunity {
    val requestBody = opportunity
    val localVariableQuery: MultiValueMap = mutableMapOf()
   ...
   */ 
  @Suppress("UNCHECKED_CAST")
  override fun updatePropertiesOnOpportunity(opportunityId: Long, opportunity: Opportunity?) : Opportunity {
    val requestBody = opportunity
    val localVariableQuery: MultiValueMap = mutableMapOf()
