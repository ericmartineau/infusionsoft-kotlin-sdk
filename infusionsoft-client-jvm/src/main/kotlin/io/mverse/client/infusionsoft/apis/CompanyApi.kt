...
class CompanyApi(bearerToken:String, basePath: String = "https://api.infusionsoft.com/crm/rest/v1") : ApiClient(basePath, bearerToken) {
  ...
  fun listCompanies(limit: Int? = null, offset: Int? = null, companyName: String? = null, order: String? = null, orderDirection: String? = null, optionalProperties: List<String>? = null) : CompanyList {
    ...
    val response = request(
      localVariableConfig,
      requestBody, 
      CompanyList.serializer(),UnitSerializer)
