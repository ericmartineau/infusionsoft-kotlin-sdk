...
class ProductApi(bearerToken:String, basePath: String, gson: Gson) : ApiClient(basePath, bearerToken, gson) {
  ...
  fun createProduct(createProduct: CreateProduct) : Product {
    ...
    val response = request<Product>(localVariableConfig, requestBody)

    return when (response) {
      is Success<*> -> response.data as Product
  ...
  fun createProductSubscription(productId: Long, createProductSubscription: CreateProductSubscription) : ProductSubscription {
    ...
    val response = request<ProductSubscription>(localVariableConfig, requestBody)

    return when (response) {
      is Success<*> -> response.data as ProductSubscription
      is Informational<*> -> TODO()
      is Redirection<*> -> TODO()
      is ClientError<*> -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError<*> -> throw ServerException(response.message ?: "Server error")
  ...
  fun listProducts(limit: Int? = null, offset: Int? = null, active: Boolean? = null) : ProductList {
    ...
    val response = request<ProductList>(localVariableConfig, requestBody)

    return when (response) {
      is Success<*> -> response.data as ProductList
      is Informational<*> -> TODO()
      is Redirection<*> -> TODO()
      is ClientError<*> -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError<*> -> throw ServerException(response.message ?: "Server error")
  ...
  fun listProductsFromSyncToken(syncToken: String? = null, limit: Int? = null, offset: Int? = null) : ProductStatusList {
    ...
    val response = request<ProductStatusList>(localVariableConfig, requestBody)

    return when (response) {
      is Success<*> -> response.data as ProductStatusList
      is Informational<*> -> TODO()
      is Redirection<*> -> TODO()
      is ClientError<*> -> throw ClientException(response.body as? String ?: "Client error")
      is ServerError<*> -> throw ServerException(response.message ?: "Server error")
