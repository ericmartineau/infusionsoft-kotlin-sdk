...
class UserInfoApiImpl(bearerToken:String, basePath: String, gson: Gson) : UserInfoApi, ApiClient(basePath, bearerToken, gson) {
  ...
  override fun getUserInfo() : UserInfoDTO {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<UserInfoDTO>() {}.type)
