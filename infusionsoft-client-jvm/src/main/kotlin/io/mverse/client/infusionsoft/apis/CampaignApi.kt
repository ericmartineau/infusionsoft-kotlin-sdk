...
class CampaignApi(bearerToken:String, basePath: String = "https://api.infusionsoft.com/crm/rest/v1") : ApiClient(basePath, bearerToken) {
  ...
  fun getCampaign(campaignId: Long, optionalProperties: List<String>? = null) : Campaign {
    ...
    val response = request(
      localVariableConfig,
      requestBody, 
      Campaign.serializer(),UnitSerializer)
  ...
  fun listCampaigns(limit: Int? = null, offset: Int? = null, searchText: String? = null, order: String? = null, orderDirection: String? = null) : CampaignList {
    ...
    val response = request(
      localVariableConfig,
      requestBody, 
      CampaignList.serializer(),UnitSerializer)
