...
if (userId != null) localVariableQuery["user_id"] to listOf("$userId")
if (stageId != null) localVariableQuery["stage_id"] to listOf("$stageId")
if (searchTerm != null) localVariableQuery["search_term"] to listOf("$searchTerm")
