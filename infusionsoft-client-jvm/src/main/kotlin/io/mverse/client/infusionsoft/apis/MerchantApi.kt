...
class MerchantApi(bearerToken:String, basePath: String = "https://api.infusionsoft.com/crm/rest/v1") : ApiClient(basePath, bearerToken) {
  ...
  fun getMerchantAccounts() : RestMerchantAccountResponse {
    ...
    val response = request(
      localVariableConfig,
      requestBody, 
      RestMerchantAccountResponse.serializer(),UnitSerializer)
