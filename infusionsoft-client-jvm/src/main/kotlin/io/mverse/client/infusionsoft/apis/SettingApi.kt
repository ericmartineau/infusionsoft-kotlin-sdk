...
class SettingApi(bearerToken:String, basePath: String = "https://api.infusionsoft.com/crm/rest/v1") : ApiClient(basePath, bearerToken) {
  ...
  fun getApplicationEnabled() : Setting {
    ...
    val response = request(
      localVariableConfig,
      requestBody, 
      Setting.serializer(),UnitSerializer)
