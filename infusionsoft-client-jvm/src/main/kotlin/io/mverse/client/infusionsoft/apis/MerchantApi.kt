...
class MerchantApiImpl(bearerToken:String, basePath: String, gson: Gson) : MerchantApi, ApiClient(basePath, bearerToken, gson) {
  ...
  override fun getMerchantAccounts() : RestMerchantAccountResponse {
    ...
    return when (response) {
      is Success -> gson.fromJson(response.data, object : TypeToken<RestMerchantAccountResponse>() {}.type)
